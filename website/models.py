...
class Account(db.Model, fo.UserMixin):
    ...
    GBP = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    JPY = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    CAD = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    AUD = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    CHF = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    AOA = db.Column(db.Numeric(9, 2), default = de.Decimal("0"))
    ...
    name_GBP = db.Column(db.String(50))
    name_JPY = db.Column(db.String(50))
    name_CAD = db.Column(db.String(50))
    name_AUD = db.Column(db.String(50))
    name_CHF = db.Column(db.String(50))
    name_AOA = db.Column(db.String(50))
    IBAN_STN = db.Column(db.String(100))
    IBAN_EUR = db.Column(db.String(100))
    IBAN_USD = db.Column(db.String(100))
    IBAN_GBP = db.Column(db.String(100))
    IBAN_JPY = db.Column(db.String(100))
    IBAN_CAD = db.Column(db.String(100))
    IBAN_AUD = db.Column(db.String(100))
    IBAN_CHF = db.Column(db.String(100))
    IBAN_AOA = db.Column(db.String(100))
    account_AOA = db.Column(db.String(50))
    bank_AOA = db.Column(db.String(50))
